        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <div class="mb-12 col-12 col-md-12 err">
                 ...
                 <form  class="formula" action="create.php" method="post" enctype="multipart/form-data">
                     ...
                     <label for="editor" class="form-label">Зміст запису</div></label>
                     ...
                     <select name="topic" class="form-select mb-2" aria-label="Default select example">
                           <option selected> Категорія меню: </option>
